    ...
    if 'llava' in model_name.lower() or 'surav' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            if 'mpt' in model_name.lower():
                ...
                print(f"############ LLAVA GEMMA MODEL IS BEING LOADED ##############")
            ...
            mm_projector_weights = torch.load(os.path.join('/workspace/mllm_research/LLaVA/gemma_llava_pretrain_checkpoints/llava-gemma-2b-vit-pretrain/', 'mm_projector.bin'), map_location='cpu')
